...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyAggieNew.MainContentActivity, MyAggieNew", MainContentActivity.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MainContentActivity.class)
			mono.android.TypeManager.Activate ("MyAggieNew.MainContentActivity, MyAggieNew", "", this, new java.lang.Object[] {  });
	}
